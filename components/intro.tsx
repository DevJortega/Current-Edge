...
export function Intro({ isDark }: IntroProps) {
  return (
    ...
    >
      ...
      >
        <Image
          src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/current-edge-logo.png%281%29%285%29%282%29%281%29-KfXykJovhZS9x2XksMd71ubionhH2P.png"
