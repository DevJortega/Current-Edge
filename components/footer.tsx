...
export default function Footer({ isDark = false }: FooterProps) {
  return (
    <footer
      id="contacto"
      className="bg-transparent py-12 px-4 sm:px-6 lg:px-8 relative"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className={`font-bold text-lg text-popover-foreground ${
          ...
          <div>
            <h4 className={`font-semibold mb-4 text-lg text-popover-foreground ${
            ...
            <div className={`space-y-2 text-sm ${
              ...
              <p>
                <span className="font-medium text-popover-foreground">Design Leader: Jorge Ortega   
              </p>
              <p>
                <span className="font-medium text-popover-foreground">Archivist: Darwin Diaz  
              </p>
              <p>
                <span className="font-medium text-popover-foreground">Com Officer: Laura Guerrero  
              </p>
              <p>
                <span className="font-medium text-popover-foreground">R&amp;F Manager: Kenneth Lascarro 
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
          <div className="text-center sm:text-left">
            <p className={`text-popover-foreground text-sm ${
              isDark ? "text-white" : "text-gray-700"
            }`}>© 2025 Current Edge - Team Bravo | Electrónica III</p>
            <p className={`text-popover-foreground text-sm ${
