  ...
  const socialLinks = [
    {
      icon: GithubIcon,
      label: "GitHub",
      href: "https://github.com/electrotech-solutions",
      color: "hover:text-gray-900",
    },
    {
      icon: LinkedinIcon,
      label: "LinkedIn",
      href: "https://linkedin.com/company/electrotech-solutions",
      color: "hover:text-blue-600",
    },
    {
      icon: MailIcon,
      label: "Email",
      href: "mailto:contacto@electrotech-solutions.com",
  ...
  const contactInfo = [
    {
      icon: MailIcon,
      label: "Email",
      value: "contacto@currentedge-solutions.com",
    },
    {
      icon: PhoneIcon,
      label: "Teléfono",
    ...
    },
    {
      icon: MapPinIcon,
      label: "Ubicación",
      value: "Universidad del Norte, Campus Principal",
    },
  ]
